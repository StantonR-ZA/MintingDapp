...
export default class Dapp extends React.Component<Props, State> {
  ...
  render() {
    return (
      <>
       <div className="items-center justify-center p-1 text-center"><span className="text-red-500  text-5xl"><b>&nbsp;</b></span></div>
        {this.isNotMainnet() ?
              ...
              <>
                ...
                {!this.isSoldOut() ?
                  ...
                  <div className="collection-sold-out">
                    ...
                    You can buy from current holders on <a href={this.generateMarketplaceUrl()} target="_blank">{CollectionConfig.marketplaceConfig.name}</a>.
                  </div>
                }
              </>
              :
        ...
        :
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">
              We provide a <strong>super-safe minting experience.</strong><br />
